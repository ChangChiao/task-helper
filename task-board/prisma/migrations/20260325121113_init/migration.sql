...
-- CreateEnum
CREATE TYPE "TaskStatus" AS ENUM ('open', 'in_progress', 'completed', 'reviewed', 'cancelled');
...
-- CreateIndex
CREATE UNIQUE INDEX "Application_taskId_userId_key" ON "Application"("taskId", "userId");
